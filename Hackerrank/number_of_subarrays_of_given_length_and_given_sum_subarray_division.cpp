// Sub-array Division    or    Count of subarrays having given length and given sum
/*
...
summing to Ron's birth day,  with a length equalling his birth month, . In this case, 
